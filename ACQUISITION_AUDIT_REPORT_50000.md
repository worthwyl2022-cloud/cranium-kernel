...
**Date:** 2026-09-12  
**Campaign ID:** `CRANIUM-STRESS-50K-MTYMJ710`  
...
| **Total Duration** | **2.41 seconds** | Continuous microsecond execution |
| **Throughput** | **20,755.5 ops/sec** | Zero external network bottlenecks |
...
- **p95:** ~354 &mu;s
- **p99:** ~467 &mu;s
- **Max Latency:** ~1256 &mu;s

---

## 5. Merkle Root Verification Proof

The Master Merkle Root (`d1f1446c0e2feba5a9153014270b982576d46591da61ba037fd63711e4424da3`) guarantees non-repudiation of all 50 batches. Prospective acquirers can verify the cryptographic integrity of any batch directly in the Cranium Diligence Workspace.

### Sample Batch Merkle Roots (Batches 0 to 4):
- **Batch #0 (Tests 0–999):** Root = `d1cd456916361be7dd35f3fbb3eec42582aa1c216c91c0c6d160cdf8210155df` (Granted: 0, Denied: 1000)
- **Batch #1 (Tests 1000–1999):** Root = `048e31bd7399206a07c5d5215009fed95c4e4cff9f6f3e1d0e12e5cc1bd8a132` (Granted: 0, Denied: 1000)
- **Batch #2 (Tests 2000–2999):** Root = `66d34e1d95c87d687e8c34aaf8a9f3e5e147303eb5b7afd2e8c5475c2b06e445` (Granted: 0, Denied: 1000)
- **Batch #3 (Tests 3000–3999):** Root = `777bacc52574db3ca1f3af7d515b0316f4b35131751452d4b2686f4eba622e4f` (Granted: 0, Denied: 1000)
- **Batch #4 (Tests 4000–4999):** Root = `ca4fdd90ebf97e664a1def9577a649bf7a5daee55a1bcfce8d353edb43ca5211` (Granted: 0, Denied: 1000)
